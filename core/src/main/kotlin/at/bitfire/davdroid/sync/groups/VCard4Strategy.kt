...
class VCard4Strategy(val addressBook: LocalAddressBook): ContactGroupStrategy {
    ...
    override suspend fun beforeUploadDirty() {
        try {
                ...
                try {
                    ...
                    for (groupID in cachedGroups disjunct currentGroups) {
                        ...
                        batch += BatchOperation.CpoBuilder
                            .newUpdate(
                                ContentUris.withAppendedId(ContactsContract.Groups.CONTENT_URI, groupID).asSyncAdapter()
                            )
            ...
            throw LocalStorageException("Couldn't mark contact groups as dirty", e)
        }
    }
