...
import at.bitfire.davdroid.settings.AccountManagerSettingsStore.Companion.SYNC_INTERVAL_MANUALLY
...
class AccountSettingsMigration11 @Inject constructor(
    ...
    override fun migrate(account: Account) {
        ...
        tasksAppManager.currentProvider()?.let { provider ->
            ...
            if (interval != null)
                accountManager.setAndVerifyUserData(account, AccountManagerSettingsStore.KEY_SYNC_INTERVAL_TASKS, interval.toString())
        }
    }
