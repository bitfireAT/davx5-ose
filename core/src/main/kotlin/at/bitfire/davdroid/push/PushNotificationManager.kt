...
class PushNotificationManager @Inject constructor(
     ...
     */
    private fun notificationId(accountId: AccountId, dataType: SyncDataType): Int {
        return accountId.hashCode() + dataType.hashCode()
    }
     ...
     */
    suspend fun notify(accountId: AccountId, dataType: SyncDataType) {
        val accountName = accountRepository.getAccountName(accountId)
        notify(
            id = notificationId(accountId, dataType),
            ...
            subText = accountName,
            intent = AccountActivity.createIntent(context, accountId)
        )
    }
     ...
     */
    fun dismiss(accountId: AccountId, dataType: SyncDataType) = dismiss(notificationId(accountId, dataType))
