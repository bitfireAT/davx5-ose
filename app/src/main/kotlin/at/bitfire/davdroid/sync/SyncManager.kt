...
abstract class SyncManager<
    CollectionType: LocalCollection<ResourceType, DataObjectType>,
    ResourceType: LocalResource<DataObjectType>,
    DataObjectType,
    RemoteType: DavCollection
>(
    val account: Account,
     ...
     */
    private fun handleException(e: Throwable, local: ResourceType?, remote: HttpUrl?) {
        var message: String
        when (e) {
            is IOException -> {
