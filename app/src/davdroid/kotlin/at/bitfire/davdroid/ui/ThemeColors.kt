...
object M3ColorScheme {
    ...
    val primaryContainerDark = Color(0xFF2b4310)
    val onPrimaryContainerDark = Color(0xFFdbeec7)
    val secondaryDark = Color(0xFFff7f2a)
    val onSecondaryDark = Color(0xFFFFFFFF)
    val secondaryContainerDark = Color(0xFF3e332e)
    val onSecondaryContainerDark = Color(0xFFecd4c3)
    val tertiaryDark = Color(0xFF658a24)
    val onTertiaryDark = Color(0xFFFFFFFF)
    val tertiaryContainerDark = Color(0xFF4b661b)
    val onTertiaryContainerDark = Color(0xFFd6ecb4)
    val errorDark = Color(0xFFe93434)
    val onErrorDark = Color(0xFFFFFFFF)
    val errorContainerDark = Color(0xFF4f1212)
    val onErrorContainerDark = Color(0xFFf6d0d0)
    ...
    val inversePrimaryDark = Color(0xFFb4e47d)
