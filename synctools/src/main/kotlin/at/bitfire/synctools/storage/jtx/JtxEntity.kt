 ...
 * @param binaryDataRows Sub-row values that might contain additional binary data associated with a specific sub-row.
 */
data class JtxEntity(
    val entity: Entity,
    val binaryDataRows: List<BinaryDataRow> = emptyList(),
)
